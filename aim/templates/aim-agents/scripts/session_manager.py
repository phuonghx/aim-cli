...
Usage:
    python .aim-agents/scripts/session_manager.py status [path]
    python .aim-agents/scripts/session_manager.py info [path]
"""
...
def count_files(root: Path) -> Dict[str, int]:
    ...
    exclude = {".git", "node_modules", ".next", "dist", "build", ".aim-agents", ".aim-agents", ".gemini", "__pycache__"}

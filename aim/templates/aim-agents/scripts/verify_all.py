...
VERIFICATION_SUITE = [
    # P0: Security (CRITICAL)
    {
        "category": "Security",
        "checks": [
            ("Security Scan", ".aim-agents/skills/vulnerability-scanner/scripts/security_scan.py", True),
            ("Dependency Analysis", ".aim-agents/skills/vulnerability-scanner/scripts/dependency_analyzer.py", False),
        ]
    },
    ...
    # P1: Code Quality (CRITICAL)
    {
        ...
        "checks": [
            ("Lint Check", ".aim-agents/skills/lint-and-validate/scripts/lint_runner.py", True),
            ("Type Coverage", ".aim-agents/skills/lint-and-validate/scripts/type_coverage.py", False),
        ]
    },
    ...
    # P2: Data Layer
    {
        "category": "Data Layer",
        "checks": [
            ("Schema Validation", ".aim-agents/skills/database-design/scripts/schema_validator.py", False),
        ]
    },
    ...
    # P3: Testing
    {
        "category": "Testing",
        "checks": [
            ("Test Suite", ".aim-agents/skills/testing-patterns/scripts/test_runner.py", False),
        ]
    },
    ...
    # P4: UX & Accessibility
    {
        ...
        "checks": [
            ("UX Audit", ".aim-agents/skills/frontend-design/scripts/ux_audit.py", False),
            ("Accessibility Check", ".aim-agents/skills/frontend-design/scripts/accessibility_checker.py", False),
        ]
    },
    ...
    # P5: SEO & Content
    {
        ...
        "checks": [
            ("SEO Check", ".aim-agents/skills/seo-fundamentals/scripts/seo_checker.py", False),
            ("GEO Check", ".aim-agents/skills/geo-fundamentals/scripts/geo_checker.py", False),
        ]
    },
    ...
    # P6: Performance (requires URL)
    {
        ...
        "requires_url": True,
        "checks": [
            ("Lighthouse Audit", ".aim-agents/skills/performance-profiling/scripts/lighthouse_audit.py", True),
            ("Bundle Analysis", ".aim-agents/skills/performance-profiling/scripts/bundle_analyzer.py", False),
        ]
    },
    ...
    # P7: E2E Testing (requires URL)
    {
        ...
        "requires_url": True,
        "checks": [
            ("Playwright E2E", ".aim-agents/skills/webapp-testing/scripts/playwright_runner.py", False),
        ]
    },
    ...
    # P8: Mobile (if applicable)
    {
        "category": "Mobile",
        "checks": [
            ("Mobile Audit", ".aim-agents/skills/mobile-design/scripts/mobile_audit.py", False),
        ]
    },
    ...
    # P9: Internationalization
    {
        ...
        "checks": [
            ("i18n Check", ".aim-agents/skills/i18n-localization/scripts/i18n_checker.py", False),
        ]
    },
]
...
def main():
    parser = argparse.ArgumentParser(
        description="Run complete AIM verification suite",
...
Examples:
  ...
  python scripts/verify_all.py . --url https://staging.example.com --no-e2e
    ...
    start_time = datetime.now()
    # Detect agent directory dynamically (default to .aim-agents if exists, fallback to .agent)
    agent_dir_name = ".aim-agents" if (project_path / ".aim-agents").exists() else ".aim-agents"
    ...
    for suite in VERIFICATION_SUITE:
        ...
        for name, script_path, required in suite["checks"]:
            actual_script_path = Path(script_path.replace(".aim-agents", agent_dir_name))

...
1. Read `.aim-agents/memory/MEMORY.md` index
...
1. Grep across `.aim-agents/memory/*.md` for the search term
...
```
1. Check: Does `.aim-agents/memory/MEMORY.md` exist?
...
|----------|---------|----------|----------|
| **Memory** | Cross-session knowledge | Permanent until pruned | `.aim-agents/memory/` |

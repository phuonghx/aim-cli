---
name: project-memory
description: Rules for managing tasks, project documentation, cross-referencing, and cross-session memory.
when_to_use: "Activate when resolving project tasks, creating documentation, referencing files, or logging persistent session memories."
---
